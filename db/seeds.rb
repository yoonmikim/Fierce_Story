...
char = Character.create!(name: "Bo", gender_id: 1, adjective: "feminist", character_description_one: "appreciated nature", character_description_two: "a wheelchair user", pronoun_one_id: 2, pronoun_two_id: 2, pronoun_three_id: 1, pronoun_four_id: 1, race_id: 1, ethnicity_id: 1)
char2 = Character.create!(name: "Faren", gender_id: 4, race_id: 3, pronoun_one_id: 3, pronoun_two_id: 4, pronoun_three_id: 5, pronoun_four_id: 4, adjective: "smart", character_description_one: "enjoyed playing games", character_description_two: "a wheelchair user", ethnicity_id: 3)
char3 = Character.create!(name: "Dak", gender_id: 3, race_id: 6, pronoun_one_id: 2, pronoun_two_id: 2, pronoun_three_id: 1, pronoun_four_id: 2, adjective: "strong", character_description_one: "appreciated nature", character_description_two: "a person with visual disability", ethnicity_id: 2)
